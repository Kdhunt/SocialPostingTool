...
- Playwright lives in `apps/web-e2e`. Do not commit `E2E_PASSWORD`, ward codes, or `apps/web-e2e/.auth/` session files; use `apps/web-e2e/.env` or `pnpm --filter @ward-comms/web-e2e test:e2e:save-session`.
