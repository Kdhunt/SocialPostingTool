...
| Login returns `FUNCTION_INVOCATION_FAILED` | Nest Lambda crashed on missing `reflect-metadata` (pnpm layout) or Prisma CJS named imports. The Lambda must bundle JS as CommonJS, stub Nest optional peers, and copy Prisma/Argon2 natives. |
